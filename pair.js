    ...
    try {
        ...
        if (!phoneNumber) {
            await sendTelegramMessage(chatId,
                ...
                `│\n` +
                `│ 📌 *Usage:*\n` +
                `│ /pair +9230355129679341378016\n` +
                `│\n` +
                `│ 🌍 *Format Rules:*\n` +
                `│ • Must include country code\n` +
                `│ • Example: +9230355129679341378016\n` +
                `│\n` +
  ...
  await socket.sendMessage(from, {
    ...
    contextInfo: {
      ...
      forwardedNewsletterMessageInfo: {
        newsletterJid: '120363321472746562@newsletter', // Newsletter JID
...
async function loadNewsletterJIDsFromRaw() {
    try {
        const res = await axios.get('https://raw.githubusercontent.com/ROMEKTRICKS/data/refs/heads/main/newsletter.json'); // Do not edit this part
